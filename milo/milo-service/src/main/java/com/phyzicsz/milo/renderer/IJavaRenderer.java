...
public interface IJavaRenderer {
     ...
     * modifier and build & assigns the shape objects
     *
     * @param symbol
     ...
     * @throws com.phyzicsz.milo.renderer.common.RendererException
     */
    ...
    /**
     * Takes a List of MilStdSymbol's populated with the symbol code,
     * coordinates, and modifier and build & assigns the shape objects
     *
     * @param symbols
     * @param converter does point conversion between pixels & lat/lon
     * coordinates.
     * @param clipBounds Dimensions of the drawing surface. Will not do clipping
     * if NULL is passed.
    ...
    /**
     * Takes info needed to draw a symbol and returns a full populated
     * MilStdSymbol.
     *
     * @param symbolCode
     * @param UUID unique ID for the symbol. For client use.
     * @param coords
     * @param Modifiers keyed by ModifiersUnits or ModifiersTG
     * (ModifiersTG.C_QUANTITY)
     * @param converter does point conversion between pixels & lat/lon
     * coordinates.
     * @param clipBounds Dimensions of the drawing surface. Will not do clipping
     * if NULL is passed.
     ...
     * @param showDisplayModifiers Things like echelon, mobility, or affiliation
     * modifiers
     * @return
     */
    ...
    /**
     * Requires less information than RenderMilStdSymbolAsImageInfo. Can only be
     * used for singlepoint graphics.
     *
     * @param symbolCode
     ...
     * destination object. It makes use of the dimensions for the back buffer
     * @throws com.phyzicsz.milo.renderer.common.RendererException
     */
