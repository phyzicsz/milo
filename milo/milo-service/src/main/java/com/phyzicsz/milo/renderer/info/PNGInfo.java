...
public class PNGInfo {
    ...
    private static final Logger logger = LoggerFactory.getLogger(PNGInfo.class);
    ...
    public byte[] getImageAsByteArray() {
        ...
        try {
            ...
            logger.error("error getting byte array", ex);
        }
        return byteArray;
    }
...
//                            ErrorLogger.LogMessage(foo.getChildNodes().item(i).getNodeName());
                ...
                logger.error("error getting array with metadata, returning null");
                return null;
            }

        } catch (IOException | TransformerException exc) {
            logger.error("error getting byte array with metadata");
            return null;
        }
    ...
    public PNGInfo centerImage() {
        ...
        try {
            ...
            logger.error("error centering image", ex);
        }
        return pi;
    }
