...
import com.phyzicsz.milo.renderer.tactical.clsUtility;
...
public final class clsRenderer2 {
            ...
            ArrayList<Shape2>shapes)
    {
        try
        {
            ...
            HashMap hmap=com.phyzicsz.milo.renderer.tactical.clsUtility.getMSRSegmentColors(tg);
            Shape2 shape=null;
            
            BasicStroke stroke=null;            
            if(tg.get_Client().equalsIgnoreCase("ge"))            
                stroke=com.phyzicsz.milo.renderer.tactical.clsUtility.getLineStroke2(tg.get_LineThickness(),tg.get_LineStyle(),BasicStroke.CAP_ROUND,BasicStroke.JOIN_ROUND);                
            else
                stroke=com.phyzicsz.milo.renderer.tactical.clsUtility.getLineStroke(tg.get_LineThickness(),tg.get_LineStyle(),BasicStroke.CAP_ROUND,BasicStroke.JOIN_ROUND);
        ...
        try
        {
            ...
            if(clipBounds != null)
            {
                ...
                else if(clipBounds.getClass().isAssignableFrom(ArrayList.class))
                {
                    ...
                    clipBounds2=com.phyzicsz.milo.renderer.multipoint.clsUtility.getMBR(clipArray);
                }
            }
            ...
            Shape2 hatchShape=com.phyzicsz.milo.renderer.tactical.clsUtility.getHatchShape(tg,bi);
            ...
            if(bolMeTOC<=0)
            {
                ...
                com.phyzicsz.milo.renderer.multipoint.clsUtility.ResolveDummyShapes(tg, shapes);
            }
