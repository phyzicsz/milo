...
import com.phyzicsz.milo.renderer.tactical.Modifier2;
import com.phyzicsz.milo.renderer.tactical.clsChannelUtility;
import com.phyzicsz.milo.renderer.tactical.clsMETOC;
import com.phyzicsz.milo.renderer.tactical.P1;
...
public final class clsRenderer {
    ...
    public static MilStdSymbol createMilStdSymboFromTGLight(TGLight tg, IPointConversion converter) {
        ...
        try {
            ...
            com.phyzicsz.milo.renderer.tactical.clsUtility.initializeLinetypes(std);
            //tg.set_SymbolId(symbolId);
            int lineType = com.phyzicsz.milo.renderer.tactical.clsUtility.GetLinetypeFromString(symbolId);
            //tg.set_LineType(lineType);
            String status = tg.get_Status();
            //int linestyle=-1;
            if (status != null && status.equals("A")) {
                if (com.phyzicsz.milo.renderer.tactical.clsUtility.isBasicShape(lineType) == false) {
                    //tg.set_LineStyle(1);
                    //linestyle=-1;
                }
            }
            ...
            boolean isClosedArea = com.phyzicsz.milo.renderer.tactical.clsUtility.isClosedPolygon(lineType);
            if (isClosedArea) {
                com.phyzicsz.milo.renderer.tactical.clsUtility.ClosePolygon(tg.Pixels);
                com.phyzicsz.milo.renderer.tactical.clsUtility.ClosePolygon(tg.LatLongs);
            }
    ...
    public static int getRevDLinetype(TGLight tg) {
        ...
        try {
            ...
            {
                linetype = com.phyzicsz.milo.renderer.tactical.clsUtility.GetLinetypeFromString(symbolId);
            }
    ...
    public static TGLight createTGLightFromMilStdSymbol(MilStdSymbol milStd,
        ...
        try {
            ...
            if (com.phyzicsz.milo.renderer.tactical.clsUtility.isBasicShape(lineType)) {
...
//            tg.set_N(ModifiersTG.N_HOSTILE);
            ...
            if (computeChannelPt) {
                switch (lineType) {
                    ...
                    case TacticalLines.AXAD:
                        POINT2 ptPixels = com.phyzicsz.milo.renderer.tactical.clsUtility.ComputeLastPoint(tg.Pixels);
    ...
    public static void render_TG(TGLight tg,
        ...
        try {
            ...
            isClosedArea = com.phyzicsz.milo.renderer.tactical.clsUtility.isClosedPolygon(lineType);
    ...
    private static void GetLineArray(TGLight tg,
        ...
        try {
            ...
            int minPoints2 = com.phyzicsz.milo.renderer.tactical.clsUtility.GetMinPoints(lineType);
            ref<int[]> minPoints = new ref();
            ArrayList<POINT2> channelPoints = new ArrayList();
            boolean bolChange1 = com.phyzicsz.milo.renderer.tactical.clsUtility.IsChange1Area(lineType, minPoints);
            int bolMeTOC = com.phyzicsz.milo.renderer.tactical.clsMETOC.IsWeather(tg.get_SymbolId());
            ...
            if (converter == null) {
                com.phyzicsz.milo.renderer.tactical.clsUtility.getHatchShape(tg, bi);
            }
            ...
            if (bolChange1) {
                tg.Pixels.clear();
                //fills tg.Pixels
                bolChange1 = com.phyzicsz.milo.renderer.multipoint.clsUtilityCPOF.Change1TacticalAreas(tg, lineType, converter, shapes);
                //points = tg.Pixels;
            } else if (bolMeTOC > 0) {
                try {
                    clsMETOC.GetMeTOCShape(tg, shapes, rev);
                } catch (Exception ex) {
                    com.phyzicsz.milo.renderer.tactical.clsUtility.WriteFile("Error in ClsMETOC.GetMeTOCShape");
                }
            } else {
            ...
            //}
            //BufferedImage bi=new BufferedImage(8,8,BufferedImage.TYPE_INT_ARGB);
            com.phyzicsz.milo.renderer.tactical.clsUtility.SetShapeProperties(tg, shapes, bi);
...
//            }
            ...
            com.phyzicsz.milo.renderer.multipoint.clsUtility.RemoveDuplicatePoints(tg);

            int rev = tg.getSymbologyStandard();
            com.phyzicsz.milo.renderer.tactical.clsUtility.initializeLinetypes(rev);
            com.phyzicsz.milo.renderer.tactical.clsUtility.setRevC(tg);

            int linetype = tg.get_LineType();
            if (linetype < 0) {
                linetype = com.phyzicsz.milo.renderer.tactical.clsUtility.GetLinetypeFromString(tg.get_SymbolId());
                tg.set_LineType(linetype);
            }
...
//                }
//            }
            com.phyzicsz.milo.renderer.tactical.clsUtility.InterpolatePixels(tg);
            ...
            com.phyzicsz.milo.renderer.tactical.clsUtility.FilterVerticalSegments(tg);
            clsUtility.FilterAXADPoints(tg, converter);
...
//            }
            ...
            if (modifierShapeInfos != null) {
                ...
                com.phyzicsz.milo.renderer.tactical.Modifier2.DisplayModifiers2(tg, g2d, textSpecs, isTextFlipped, converter);
                //tg.Pixels=dblPixels;
    ...
    protected static double getScale(TGLight tg,
        ...
        try {
            ...
            if (clipBounds.getClass().isAssignableFrom(Rectangle2D.Double.class)) {
                ...
                clipRect = com.phyzicsz.milo.renderer.multipoint.clsUtility.getMBR(clipArray);
            }
...
//            }
            ...
            com.phyzicsz.milo.renderer.tactical.clsUtility.FilterVerticalSegments(tg);
            boolean isChange1Area = com.phyzicsz.milo.renderer.tactical.clsUtility.IsChange1Area(linetype, null);
            boolean isTextFlipped = false;
            ...
            if (farLeftPixels.size() > 0) {
                ...
                com.phyzicsz.milo.renderer.tactical.Modifier2.DisplayModifiers2(tg, g2d, textSpecsLeft, isTextFlipped, null);
            }
            if (farRightPixels.size() > 0) {
                ...
                com.phyzicsz.milo.renderer.tactical.Modifier2.DisplayModifiers2(tg, g2d, textSpecsRight, isTextFlipped, null);
            }
            ...
            if (shapesLeft.isEmpty() || shapesRight.isEmpty()) {
                ...
                if (shapes != null && shapes.size() > 0) {
                    com.phyzicsz.milo.renderer.tactical.Modifier2.DisplayModifiers2(tg, g2d, textSpecs, isTextFlipped, null);
                    Shape2ToShapeInfo(modifierShapeInfos, textSpecs);
                    mss.setModifierShapes(modifierShapeInfos);
                }
    ...
    public static void render(TGLight tg,
        ...
        try {
            setHostileLC(tg);
            boolean isChange1Area = com.phyzicsz.milo.renderer.tactical.clsUtility.IsChange1Area(tg.get_LineType(), null);
