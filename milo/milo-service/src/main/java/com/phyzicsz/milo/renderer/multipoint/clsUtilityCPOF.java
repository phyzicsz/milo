...
//            }
    ...
    protected static void FilterPoints2(TGLight tg, IPointConversion converter) {
        try {
            ...
            tg.Pixels = pts;
            tg.LatLongs = com.phyzicsz.milo.renderer.multipoint.clsUtility.PixelsToLatLong(pts, converter);
    ...
    public static Boolean canClipPoints(TGLight tg) {
        try {
            ...
            if (com.phyzicsz.milo.renderer.tactical.clsMETOC.IsWeather(symbolId) > 0) {
                return true;
            }
...
//                }
    ...
    private static boolean segmentAnticipatedLine(TGLight tg) {
        ...
        try {
            ...
            if (com.phyzicsz.milo.renderer.multipoint.clsUtility.isAutoshape(tg)) {
                return false;
            }
    ...
    protected static void postSegmentFSA(TGLight tg,
        ...
        try {
            ...
            latLongs = resultPts;
            tg.Pixels = com.phyzicsz.milo.renderer.multipoint.clsUtility.LatLongToPixels(latLongs, converter);
        } catch (Exception exc) {
...
//                case TacticalLines.SFENCE:
            ...
            String H = "";
            String color = "";
            HashMap hmap = com.phyzicsz.milo.renderer.tactical.clsUtility.getMSRSegmentColorStrings(tg);
            if (hmap != null) {
                tg.set_H("");
            }
            ...
            if (useVincenty) {
                ...
                tg.Pixels = com.phyzicsz.milo.renderer.multipoint.clsUtility.LatLongToPixels(tg.LatLongs, converter);
                return;
            }
