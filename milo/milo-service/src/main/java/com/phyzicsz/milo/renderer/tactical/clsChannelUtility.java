...
public final class clsChannelUtility {
    private static final Logger logger = LoggerFactory.getLogger(clsChannelUtility.class);
    ...
    private static int GetPartitions(boolean[] segments,
        ...
        try {
            ...
            logger.error("channel utility error - failed to get partitions", ex);
        }
    ...
    private static int DrawGoodChannel2(int fromSegment,
        ...
        try {
            ...
            logger.error("channel utility error - failed to draw channel", ex);
        }
        return returnValue;
    }
    ...
    private static void DrawSegments(double[] pixels,
        ...
        try {
            ...
            logger.error("channel utility error - failed to draw segments", ex);
        }
    }
    /**
    ...
    private static ArrayList<POINT2> getLCPixels(TGLight tg,ArrayList<POINT2>pixels)
    {
        ...
        try
        {
            ...
            logger.error("channel utility error - failed to get lcp pixels", ex);
        }    
        return pixels2;
    }
    /**
